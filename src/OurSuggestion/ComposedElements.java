...
public class ComposedElements<T extends RequestableElement> extends Element {
	 ...
	 *            {@code Collection} the can contain.
	 */
	public ComposedElements(String collectionTitle) {
	 ...
	 */
	@Override
	public int compareTo(ComposedElements<?> collection) {
		...
		int compareTitle = this.collectionTitle.compareTo(collection.getCollectionTitle());
		if (compareTitle != 0)
			return compareTitle;
...
//			return compareType;
	...
	public boolean equals(Object collection) {
		...
		if (this.compareTo((ComposedElements) collection) != 0)
			return false;
